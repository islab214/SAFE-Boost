...
# Parse CLI arguments
# =========================================
parser = argparse.ArgumentParser(description="Run binning + HE training/inf experiments with manual parameter combos")
parser.add_argument(
    "--combos-file",
    type=str,
    default=None,
...
parser.add_argument(
    "--learning-rate", type=float, default=None, help="Default learning rate if not specified per combo"
)
...
manual_combos = [
    ...
    ### ELXGB
    ## (a)
    # {"dataset":"bank_marketing","method":"sturges", "max_bin":16, "depth":3, "n_estimators":2,  "learning_rate":0.3},
    # {"dataset":"bank_marketing","method":"sturges", "max_bin":16, "depth":3, "n_estimators":3,  "learning_rate":0.3},
    # {"dataset":"bank_marketing","method":"sturges", "max_bin":16, "depth":3, "n_estimators":4,  "learning_rate":0.3},
    # {"dataset":"bank_marketing","method":"sturges", "max_bin":16, "depth":3, "n_estimators":5,  "learning_rate":0.3}, ## default
    # {"dataset":"bank_marketing","method":"sturges", "max_bin":16, "depth":3, "n_estimators":6,  "learning_rate":0.3},
    # ## (b)
    # {"dataset":"bank_marketing","method":"sturges", "max_bin":16, "depth":2, "n_estimators":5,  "learning_rate":0.3},
    # {"dataset":"bank_marketing","method":"sturges", "max_bin":16, "depth":4, "n_estimators":5,  "learning_rate":0.3},
    # {"dataset":"bank_marketing","method":"sturges", "max_bin":16, "depth":5, "n_estimators":5,  "learning_rate":0.3},
    # {"dataset":"bank_marketing","method":"sturges", "max_bin":16, "depth":6, "n_estimators":5,  "learning_rate":0.3},
    ### ELXGB
    ## (a)
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":16, "depth":3, "n_estimators":2,  "learning_rate":0.3},
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":16, "depth":3, "n_estimators":3,  "learning_rate":0.3},
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":16, "depth":3, "n_estimators":4,  "learning_rate":0.3},
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":16, "depth":3, "n_estimators":5,  "learning_rate":0.3}, ## default
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":16, "depth":3, "n_estimators":6,  "learning_rate":0.3},
    ## (b)
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":16, "depth":2, "n_estimators":5,  "learning_rate":0.3},
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":16, "depth":4, "n_estimators":5,  "learning_rate":0.3},
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":16, "depth":5, "n_estimators":5,  "learning_rate":0.3},
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":16, "depth":6, "n_estimators":5,  "learning_rate":0.3},
    # ### SecureXGB
    ## (b)
    # {
    #     "dataset": "default_of_credit_card",
    #     "method": "sturges",
    #     "max_bin": 8,
    #     "depth": 4,
    #     "n_estimators": 1,
    ...
    # {"dataset":"default_of_credit_card","method":"sturges", "max_bin":8,  "depth":4, "n_estimators":15, "learning_rate":0.5},
    ...
    ### SecureXGB
    ## (b)
    # {"dataset": "processed_bank_marketing4", "method": "sturges", "max_bin": 8, "depth": 4, "n_estimators": 1, "learning_rate": 0.5},
    # {"dataset": "processed_bank_marketing4", "method": "sturges", "max_bin": 8, "depth": 4, "n_estimators": 5,"learning_rate": 0.5},
    # {
    #     "dataset": "processed_bank_marketing4",
    #     "method": "sturges",
    #     "max_bin": 8,
    #     "depth": 4,
    #     "n_estimators": 10,
    ...
    #     "learning_rate": 0.5,
    # },
    # # {"dataset":"bank_marketing","method":"sturges", "max_bin":8,  "depth":3, "n_estimators":15, "learning_rate":0.5},
    # {
    #     "dataset": "processed_bank_marketing4",
    #     "method": "sturges",
    #     "max_bin": 8,
    ...
    #     "learning_rate": 0.5,
    # },
    # # {"dataset":"bank_marketing","method":"sturges", "max_bin":8,  "depth":5, "n_estimators":15, "learning_rate":0.5},
    # {
    #     "dataset": "processed_bank_marketing4",
    #     "method": "sturges",
    #     "max_bin": 8,
    ...
    #     "learning_rate": 0.5,
    # },
    # # {"dataset":"bank_marketing","method":"sturges", "max_bin":6,  "depth":4, "n_estimators":15, "learning_rate":0.5},
    # {
    #     "dataset": "processed_bank_marketing4",
    #     "method": "sturges",
    #     "max_bin": 8,
    ...
    #     "learning_rate": 0.5,
    # },
    # # {"dataset":"bank_marketing","method":"sturges", "max_bin":10, "depth":4, "n_estimators":15, "learning_rate":0.5},
    # {
    #     "dataset": "processed_bank_marketing4",
    #     "method": "sturges",
    #     "max_bin": 12,
    ...
    #### synthetic datasets
    ## (a)
    # {"dataset":"secureXGB_syn_n10m50", "method":"sturges", "max_bin":8,  "depth":4, "n_estimators":15, "learning_rate":0.5},
    # {"dataset":"secureXGB_syn_n50m50", "method":"sturges", "max_bin":8,  "depth":4, "n_estimators":15, "learning_rate":0.5}, ## default
    # {"dataset":"secureXGB_syn_n100m50","method":"sturges", "max_bin":8,  "depth":4, "n_estimators":15, "learning_rate":0.5},
    # ## (b)
